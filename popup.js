...
$("#sheetInc").click(function () {
    if (sheetNum == arr.length) {
        $("#sheetInc").prop("disabled", true);
    } else {
        $("#sheetInc").prop("disabled", false);
        sheetNum++;
    }
    if (sheetNum == 0) {
        $("#sheetDec").prop("disabled", true);
    } else {
        $("#sheetDec").prop("disabled", false);
    }
...
$("#idsColInc").click(function () {
    if (idsColNum == arr.length) {
        $("#idsColInc").prop("disabled", true);
    } else {
        $("#idsColInc").prop("disabled", false);
        idsColNum++;
    }
    if (idsColNum == 0) {
        $("#idsColDec").prop("disabled", true);
    } else {
        $("#idsColDec").prop("disabled", false);
    }
...
$("#urlsColInc").click(function () {
    if (urlsColNum == arr.length) {
        $("#urlsColInc").prop("disabled", true);
    } else {
        $("#urlsColInc").prop("disabled", false);
        urlsColNum++;
    }
    if (urlsColNum == 0) {
        $("#urlsColDec").prop("disabled", true);
    } else {
        $("#urlsColDec").prop("disabled", false);
    }
    updateLetters();
...
$("#pubsColInc").click(function () {
    if (pubsColNum == arr.length) {
        $("#pubsColInc").prop("disabled", true);
    } else {
        $("#pubsColInc").prop("disabled", false);
        pubsColNum++;
    }
    if (pubsColNum == 0) {
        $("#pubsColDec").prop("disabled", true);
    } else {
        $("#pubsColDec").prop("disabled", false);
    }
